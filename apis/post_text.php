...
$query = "INSERT INTO wall_posts (rid , type , post , user_id , total_likes , total_comments , created_date , post_type) VALUES ('$rid' , 'text' , '$message' , '$user_id' , '0' , '0' , '$create_date' , '$post_type')";
